...
// credentials exist to set one up from here. The original inbox sweep this design grew out of
// was a Claude Code scheduled task with its own mail MCP connector — that kind of access is
// out of reach for a server-side edge function deployed autonomously. So this function does NOT
...
//
// To wire this up for real autonomous operation later, the operator needs to either:
