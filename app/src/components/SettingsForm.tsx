  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="rounded-xl border border-border bg-surface p-6">
        ...
        <form onSubmit={handleSaveRules} className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-4">
          ...
          <label className="flex flex-col gap-1 text-sm text-text-dim">
            ...
            <input
              type="number"
              value={timing.ghost_weeks}
              onChange={(e) => setTiming((t) => ({ ...t, ghost_weeks: Number(e.target.value) }))}
              className="rounded-lg border border-border bg-bg px-3 py-2 text-text outline-none focus:border-accent"
            />
          </label>
          <label className="flex flex-col gap-1 text-sm text-text-dim">
      ...
      <section className="rounded-xl border border-border bg-surface p-6">
        ...
        <a
          href="/onboarding"
          className="mt-3 inline-block rounded-lg border border-border px-4 py-2 text-sm text-text-dim transition-colors hover:text-text"
        >
