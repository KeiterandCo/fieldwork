...
/** Playful rotating lines for the prep bar (module-level so the rotation timer is stable). */
const PREP_PHRASES = [
  'Reading the job description closely…',
  'Anticipating their tough questions…',
  'Pulling your real stories…',
  'Sharpening your best angles…',
  'Drafting questions for them…',
      ...
      >
        ...
        {genState === 'generating' && (
          <div className="w-full">
            <BuildProgress stages={PREP_STAGES} phrases={PREP_PHRASES} done={genDone} />
          </div>
        )}
