                ...
                <div key={app.id} className="group relative">
                  ...
                  {app.status === 'to_apply' && (
                    <button
                      ...
                      className="absolute right-1.5 top-1.5 rounded px-1.5 text-sm leading-5 text-text-dim opacity-0 transition-opacity hover:bg-danger/10 hover:text-danger focus:opacity-100 group-hover:opacity-100"
                    >
                      ×
                    </button>
                  )}
