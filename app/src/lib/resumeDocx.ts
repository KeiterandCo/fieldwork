...
// Two layout renderers ported from the real resume templates in C:\workspace\Resumes\files
// (Template1..Template4), now split into LAYOUT x COLOR instead of four fixed combos.
//
// Layout notes:
